...
module Invoicera
  class API
    ...
    # the server. Please contact contact@pierrefourgeaud.com or
    # {file a bug}[https://github.com/pierrefourgeaud/invoicera/issues].
    ...
    # === 502 Gateway Error
    #
    # The load balancer or web server had trouble connecting to the Invoicera.
